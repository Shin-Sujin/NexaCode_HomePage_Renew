$(function () {
  ...
  animation_char_come_items.forEach((t) => {
    ...
    if (
      ...
      t.getAttribute("data-on-scroll") &&
        (o = t.getAttribute("data-on-scroll")),
  ...
  fadeArray.forEach((t) => {
    ...
    if (t.getAttribute("data-fade-from")) {
      e = t.getAttribute("data-fade-from");
    }
    if (t.getAttribute("data-on-scroll")) {
      r = t.getAttribute("data-on-scroll");
    }
    if (t.getAttribute("data-delay")) {
      s = t.getAttribute("data-delay");
    }
    if (t.getAttribute("data-ease")) {
      g = t.getAttribute("data-ease");
    }
    if (1 == r) {
      if ("top" == e) {
        gsap.from(t, {
  ...
  anim_reveal.forEach((t) => {
    var a = 1.5,
      ...
      o = 0.05;
    if (t.getAttribute("data-duration")) {
      a = t.getAttribute("data-duration");
    }
    if (t.getAttribute("data-on-scroll")) {
      e = t.getAttribute("data-on-scroll");
    }
    if (t.getAttribute("data-stagger")) {
      r = t.getAttribute("data-stagger");
    }
    if (t.getAttribute("data-delay")) {
      o = t.getAttribute("data-delay");
    }
    ...
    if (1 == e) {
      t.anim = gsap.from(t.split.chars, {
        scrollTrigger: {
          trigger: t,
          start: "top 85%",
          scroller: "[data-scroll-container]",
