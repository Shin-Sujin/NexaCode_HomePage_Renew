      ...
      <div className="flex flex-col max-lg:gap-10 w-full max-md:mx-10">
        ...
        <div className="grid-container-portfolio max-md:grid-cols-1">
          ...
          <div ref={triggerRef} className="flex justify-center items-center">
            <div className="text-5xl tracking-tighter font-black word lg:text-8xl">
          ...
          {/* 2번------------ */}
          <div ref={imageRef1} className="startPage-portfolio-image-container">
          ...
          {/* 4번------------ */}
          <div ref={imageRef3} className="startPage-portfolio-image-container">
            <div className="work-box">
              <Image
          ...
          {/* 6번------------ */}
          <div ref={imageRef5} className="startPage-portfolio-image-container">
            <div className="work-box">
              <Image
