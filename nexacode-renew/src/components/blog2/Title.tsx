...
export default function Title() {
  return (
    <div className="relative w-full h-[45rem] min-w-0 min-h-0 flex items-center justify-center">
      {/* 배경 이미지 */}
      <div className="absolute inset-0 w-full h-full min-w-0 min-h-0 z-0">
        <Image
